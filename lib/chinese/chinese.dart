...
const coloryellow = Color(0xFFFFFF00);
const colorgrey = const Color(0xFFDADADA);
const colorAppbar = const Color(0xFFEE1C25);
                ...
                onTap: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (
                              context,
                              ) => BibleSearchPage(datare: data, appBarcolor: colorAppbar, bottomBarcolor: colorAppbar, lableColor: colorAppbar)
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                 //   builder: (context) => ChapterListPage(book: data[index])),
                  builder: (context) => ChapterListPage(book: data[index], appBarcolor: colorAppbar, bottomBarcolor: colorAppbar, lableColor: colorAppbar)),
              );
            },
            child: Card(
              color: colorgrey,
