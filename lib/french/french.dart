...
const colorAppbar = const Color(0xFF002654);
const colorgrey = const Color(0xFFDADADA);
const colorred = const Color(0xFFED2939);
...
class _MyAppState extends State<french> {
  List<dynamic> data = [];
  ...
  Future<String> loadBibleData() async {
    return await rootBundle.loadString('assets/fr_apee.json');
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.separated(
        ...
        const Divider(height: 5, color: colorred),
  ...
  void _createBottomBannerAd() {
    _bottomBannerAd = BannerAd(
      adUnitId: AdHelper.frenchBookBanner,
      size: AdSize.banner,
      request: AdRequest(),
